    ...
    <section style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <header>
        ...
        <p style={{ fontSize: 14, color: '#6b7280', marginTop: 6 }}>
          간편하게 모바일에서 초대장을 만들고 공유할 수 있습니다.
        </p>
      </header>

      <div style={{ display: 'grid', gap: 10 }}>
        <Link href="/m/templates" style={primaryBtn}>템플릿으로 시작하기</Link>
        <Link href="/m/my-invitations" style={secondaryBtn}>내 초대장</Link>
        <Link href="/m/dashboard" style={secondaryBtn}>대시보드</Link>
      </div>
